...
namespace ASN.AS.SunucuTarafi
{
    /// <summary>
    /// Asenkron Soketli Mesajlaþma Sunucusu
    /// </summary>
    public class ASSunucusu
    {
        // PUBLIC ÖZELLÝKLER //////////////////////////////////////////////////
        ...
        /// <summary>
        /// Bir AS sunucusu oluþturur
        /// </summary>
        /// <param name="port">Dinlenecek port</param>
        public ASSunucusu(int port)
        {
            this.port = port;
        ...
        private class BaglantiDinleyici
        {
            ...
            public BaglantiDinleyici(ASSunucusu sunucu, int port)
            {
                this.sunucu = sunucu;
                this.port = port;
            }
            ...
            /// <summary>
            /// Ayrý bir thread olarak çalýþýp gelen soket baðlantýlarýný kabul ederek 
            /// ASSunucusu modülüne ileten fonksyon.
            /// </summary>
            public void tDinle()
            {
        ...
        private class Istemci : IIstemci
        {
            ...
            public Istemci(ASSunucusu sunucu, Socket istemciSoketi, long istemciID)
            {
                this.sunucu = sunucu;
            ...
            public bool Baslat()
            {
                try
                {
                    ...
                    binaryOkuyucu = new BinaryReader(agAkisi, Encoding.Default);
                    binaryYazici = new BinaryWriter(agAkisi, Encoding.Default);
            ...
            public bool MesajYolla(string mesaj)
            {
                try
                {
                    byte[] bMesaj = System.Text.Encoding.Default.GetBytes(mesaj);
            ...
            private void tCalis()
            {
                ...
                while (calisiyor)
                {
                    try
                    {
                        ...
                        string mesaj = System.Text.Encoding.Default.GetString(bList.ToArray());
