...
namespace ASN.AS.IstemciTarafi
{
    /// <summary>
    /// Asenkron Soketli Mesajlaþma Ýstemcisi
    /// </summary>
    public class ASIstemcisi
    {
        ...
        /// <summary>
        /// Bir AS Ýstemcisi oluþturur.
        /// </summary>
        /// <param name="serverIpAdresi">AS Sunucusunun IP adresi</param>
        /// <param name="serverPort">AS sunucusunun port numarasý</param>
        public ASIstemcisi(string serverIpAdresi, int serverPort)
        {
